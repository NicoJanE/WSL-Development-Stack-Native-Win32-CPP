...
## ⚙️ Create the  WSL image (here)

- When we have the distribution installation source, we can create the WSL environment. Just type in the following command:<br>
...
<pre class="nje-cmd-one-line" style="margin-left:50px;" ><small>./CreateWSL.ps1 MyWSL ./WSL-target-dir project-name /mnt/d/project-location ./folder-to-your-installation/install.tar.g</small></pre>
<div class="nje-br"> </div>

<span class="nje-expect-indent1">After 3 till ~ 5 minutes</span>
<div class="nje-text-block" style="background-color:#e6ffed; color:#24292e; border-left:3px solid #28a745; padding:12px 16px; margin-left:21px;margin-top:-19px;">
...
### Open the .NET application container in VSC (@host)
